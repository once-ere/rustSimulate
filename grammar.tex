...
Bound states are \textbf{not} provided in 2-D: on an $n_x\times n_y$ grid
the Hamiltonian is $(n_x n_y)^2$, so a modest $200\times200$ grid gives a
$40\,000\times40\,000$ dense matrix, far beyond the Jacobi eigensolver.
Propagation has no such limit.
