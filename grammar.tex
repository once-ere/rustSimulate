...
\textbf{Accuracy falls with the imaginary part}, by cancellation rather
than anything about the recurrence: the terms grow like
...
\hline
relative error & $10^{-16}$ & $10^{-14}$ & $10^{-13}$ & $10^{-11}$ &
$10^{-9}$ & $10^{-6}$\\
\end{tabular}
\end{center}

$Y_n$ and $K_n$ are \textbf{not} provided: they need a logarithmic term
