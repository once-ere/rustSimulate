...
\textbf{The large-order machinery is not extended.} The Debye,
Airy-type and $1/z$ expansions are expansions \emph{in} the order and
their uniformity is stated for real order; reusing them would assume
something nobody proved. Complex order reaches as far as the ascending
series does, and says so rather than guessing.
