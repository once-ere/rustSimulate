...
\textbf{What is left is the Debye region at complex order}: $|z|$ a few
times $|\nu|$, where the $1/z$ expansion is refused because $|4\nu^2|$
is not small compared with $|z|$, the ascending series has cancelled,
and $x = z/\nu$ is too far from 1 for the turning-point expansion. DLMF
10.19 covers it for real order. The routines report that gap rather than
guessing in it.
