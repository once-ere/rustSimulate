...
\textbf{Still missing: the Airy-type expansion of DLMF 10.20 at complex
order.} The obstacle is concrete rather than theoretical --- it needs
$\mathrm{Ai}$ at a \emph{complex} argument, and this crate has only the
real-argument Airy functions from the vendored Cephes. So the turning
point $|z|\sim|\nu|$ at complex order is reached by the ascending series
or not at all, and the error says which.
