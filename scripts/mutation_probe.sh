...
zeno-plastic@@physical_object@@physical_object/src/integrate.rs@@let force_plastic = burst > collide::MAX_EVENTS_IN_BURST;@@let force_plastic = true;@@the Zeno guard's EFFECT: every impact becomes inelastic
